...
with open("data_raw.csv", "r") as csvfile:
...
for row in data_raw:
    ...
    if '-' in char:
        ...
        char_desc = f"{trad} (simplified: {simp})"
    else:
        trad, simp = char, char
        char_desc = char
    ...
    wu_prompt_1 %= (char_desc, mando_b, mando_a, canto_b, canto_a, trad)
    ...
    wu_prompt_2 %= (char_desc, mando_a, mando_b, canto_a, canto_b, simp)
    ...
    wu_prompt_3 %= (char_desc, mando_a, mando_b, trad, canto_a, canto_b, trad)
    ...
    canto_prompt_1 %= (char_desc, mando_b, mando_a, wu_a, wu_b, trad)
    ...
    canto_prompt_2 %= (char_desc, mando_a, mando_b, wu_a, wu_b, simp)
    ...
    canto_prompt_3 %= (char_desc, mando_a, mando_b, simp, wu_a, wu_b, simp)
    canto_prompts = [canto_prompt_1, canto_prompt_2, canto_prompt_3]

    mando_ans = f'["{mando_a}", "{mando_b}"]'
    wu_ans = f'["{wu_a}", "{wu_b}"]'
    canto_ans = f'["{canto_a}", "{canto_b}"]'
